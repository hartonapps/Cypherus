...
• `.autosave on|off` `.like` (reply to save quickly)
...
COMMAND_HELP = {
    ...
    "autosave": "Usage: .autosave on|off\nAuto-save liked (❤️ reacted) messages to Saved Messages.",
    ...
    "setaza": "Usage: .setaza\\nAccount Number: <number>\\nBank Name: <bank>\\nAccount Name: <name>\nSave AZA payment profile.",
    "aza": "Usage: .aza\nShow saved AZA payment profile.",
    "getaza": "Usage: .getaza\nShow current AZA profile (owner view).",
    "resetaza": "Usage: .resetaza\nReset AZA profile to default.",
