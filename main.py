...
from utils.ai_tools import ask_free_ai, summarize_text, translate_text, generate_horde_image, transcribe_audio_free
...
COMMAND_HELP = {
    ...
    "update": "Usage: .update\nPull latest updates without restarting.",
            ...
            if cmd in {"help", "menu"}:
                ...
                try:
                    ...
                    if "Already up to date." in out or "Already up-to-date." in out:
                        await event.edit("No updates available. Already up to date.")
                    else:
                        await event.edit((f"Update result (code {pull.returncode}):\n{out[-3500:]}")[:3900])
                except Exception as exc:
