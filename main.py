...
async def register_handlers(client: TelegramClient, label: str):
    ...
    async def command_handler(event):
        ...
        try:
            ...
            removed_cmds = {"persona","generate","code","teach","roast","ship","rate","vibecheck","truth","dare","lockchat","blockword","stats","activity","usage","alwaysonline","daily","rank","genpass","video","jokes","memes","weather","define","tourl","ghostmode","hideonline","autostoryview","autostoryreact"}
